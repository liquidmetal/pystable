...
class GyroscopeDataFile(object):
    ...
    def fetch_closest_omega(self, timestamp):
        """
...
if __name__ == '__main__':
    ...
    print g.fetch_closest_omega(0)
    print g.fetch_closest_omega(50)
    print g.fetch_closest_omega(100)

    g = GyroscopeDataFile('/work/blueprints/c7/data/VID_20150405_005248gyro.csv')
    g.parse()
    print g.fetch_closest_omega(0)
    print g.fetch_closest_omega(1)
    print g.fetch_closest_omega(5065918)
